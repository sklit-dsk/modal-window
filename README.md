...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/mVQTPXNt5r)
...
```sh
npx nx serve modal-window
```

To create a production bundle:

```sh
npx nx build modal-window
```

To see all available targets to run for a project, run:

```sh
npx nx show project modal-window
```
